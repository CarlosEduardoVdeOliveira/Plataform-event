...
export function Video(props:VideoProps) {
    ...
    const {data} = useGetLessonBySlugQuery(GET_LESSON_By_Slug_QUERY,{
        variables:{
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    <a 
                        ...
                        <div className="py-6 leading-relaxed">
                            ...
                            <p className="text-sm text-gray-208 nt-2">
                                Acesseomaterial complementar para aceleraroseu desenvolvimento
                            </p>
                        </div>
